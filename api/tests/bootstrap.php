...
function isTestSuiteSet(string $testSuite): bool
{
    return isset($_SERVER['argv'][1]) && sprintf('--testsuite=%s', $testSuite) === $_SERVER['argv'][1];
}

if (! isTestSuiteSet('all') && ! isTestSuiteSet('functional')) {
    return;
}
